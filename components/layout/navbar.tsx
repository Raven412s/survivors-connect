...
export default function Navbar() {
  return (
    <div
      className={cn(
        "fixed top-2 md:top-0 rounded-sm md:rounded-none left-2 md:left-0 right-2 md:right-0 w-full h-16 z-[60] bg-accent text-accent-foreground"
      )}
      id="navbar"
    >
      <nav className="relative w-full h-full flex items-center justify-between px-4">
        ...
        {/* Logo Section */}
        <div className="absolute left-1/2 -translate-x-1/2 md:static md:translate-x-0 flex items-center gap-1 md:gap-2">
          <div className="text-base md:text-xl font-bold p-1 flex gap-1 md:gap-2 items-center">
            ...
            <div className="hidden sm:flex flex-col items-start justify-center gap-0.5 md:gap-1">
